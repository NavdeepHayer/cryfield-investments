...
export default function Page() {
  return (
    <>
      ...
      {/* ===== ABOUT ===== */}
      <section id="about" className="bg-white scroll-mt-20 relative overflow-hidden">
        <ParallaxOrb
              ...
              <div>
                ...
                <div className="space-y-4 text-navy-600 leading-relaxed">
                  <p>
                    ...
                    both private and public sectors. Incorporated in 2017 and
                    based in London&rsquo;s West End, we have been planning,
                    designing and delivering innovative development solutions.
                  </p>
                  <p>
      ...
      {/* ===== SERVICES ===== */}
      <section id="services" className="bg-white scroll-mt-20 relative overflow-hidden">
        <ParallaxOrb
          ...
          <BlurIn>
            <div className="max-w-2xl mb-16">
              ...
              <p className="text-navy-300 text-lg">
                ...
                for offering fund diversity, product specialism, senior
                management skills, regulatory knowledge, and client
            ...
            <SlideRight delay={0.15}>
              <div className="bg-navy-800/50 border border-navy-700 rounded-lg p-10">
                ...
                <p className="text-navy-300 leading-relaxed">
                  ...
                  with planners, occupiers, and investors, and our ability to
      ...
      {/* ===== CONTACT ===== */}
      <section id="contact" className="bg-gray-50 scroll-mt-20 relative overflow-hidden">
        <ParallaxOrb
